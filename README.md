...
```
dependencies { 
    implementation 'org.infinispan.protostream:protostream:6.0.11'
}
```
...
```shell
javac --processor-path /path/to/protostream-processor-6.0.11.jar:... ...
```
...
```
dependencies {
    annotationProcessor 'org.infinispan.protostream:protostream-processor:6.0.11'
    ...
}
```
