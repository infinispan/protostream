...
```
dependencies { 
    implementation 'org.infinispan.protostream:protostream:6.0.10'
}
```
...
```shell
javac --processor-path /path/to/protostream-processor-6.0.10.jar:... ...
```
...
```
dependencies {
    annotationProcessor 'org.infinispan.protostream:protostream-processor:6.0.10'
    ...
}
```
