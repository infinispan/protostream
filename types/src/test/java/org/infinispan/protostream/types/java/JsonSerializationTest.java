...
public class JsonSerializationTest {
   ...
   public void testSerializationMatches() throws Exception {
      ...
      String actual = ProtobufUtil.toCanonicalJSON(context, bytes);
   ...
   public static Object[][] marshallingElements() {
      return new Object[][] {
            new Object[] { new TestParams(new WrappedMessage(UUID.fromString("5efbb09b-37a7-4237-bddf-e4f271db82a8")), "json/wrapped-uuid.json") },
            new Object[] { new TestParams(new WrappedMessage(List.of(UUID.fromString("ade02349-2b40-4dc9-9ad2-00cac707220b"), UUID.fromString("781da88f-a320-4c9c-b7e5-5da7b18c7d73"))), "json/list-uuid.json") },
            new Object[] { new TestParams(new PrimitiveCollections(
                  ...
                  new HashMap<>()
            ), "json/many-collections.json") },
            new Object[] { new TestParams(Instant.ofEpochSecond(1744288313, 308361201), "json/instant.json") },
            new Object[] { new TestParams(new Date(1744288478165L), "json/date.json") },
            new Object[] { new TestParams(OffsetTime.of(23,  59, 59, 10, ZoneOffset.UTC), "json/offset-time.json") },
            new Object[] { new TestParams(new ArrayList<>(List.of(new Book("Book1", "Description1", 2020), new Book("Book2", "Description2", 2021))), "json/books-list.json") },
            new Object[] { new TestParams(ZonedDateTime.of(1985, 10, 26, 0, 59, 0, 0, ZoneId.of("+07:00")), "json/zoned-time.json") },
            new Object[] { new TestParams(LocalDateTime.of(1985, 10, 26, 0, 59, 0, 0), "json/local-date-time.json") },
      };
   }

   private record TestParams(Object original, String jsonFilePath) { }
